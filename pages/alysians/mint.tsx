...
import { alysianContract, alysianDate } from "../../components/constant";
import { useMemo, useState } from "react";
import Timer from "../../components/Timer/timer";
import styles from "../ami/ami.module.css";
import { parseIneligibility } from "../../util/parseIneligibility";

const Alymint: NextPage = () => {
  const { contract: nftDrop } = useContract(alysianContract);
          ...
          {isLoading ? (
            ...
            <>
              <div className={styles.infoSide}>
                ...
                <h2> Wave Starts In </h2>
                <Timer date={alysianDate} />
              </div>
              ...
              <div className={styles.imageSide}>
                ...
                <h2>
                  Available for Wave: <b>{remaining}</b>
                </h2>
